...
<head>
    ...
    <title>Riku Lounges</title>
    <link rel=”icon” type=”image/png” href=”riku.jpg”>
...
<body class="">
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">Riku Lounges</a>
                ...
                <div class="card-header rounded-0">
                    <div class="d-flex">
                        <div class="col-auto flex-shrink-1 flex-grow-1">
                            <div class="card-title"><b>Account List</b></div>
                        </div>
                        <div class="col-auto">
                            <button class="btn btn-sm btn-primary rounded-0" id="add_pass"><i class="fa fa-plus"></i> Add Account</button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Username / Mails</th>
            ...
            <div class="modal-body rounded-0">
                <div class="container-fluid">
                    <form action="" id="password-form" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="username" class="control-label">Username / Mails</label>
